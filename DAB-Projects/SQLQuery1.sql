...
-- Opgave 19
SELECT EmployeeID,FirstName,LastName,Region,Region.RegionID,Region.RegionDescription FROM Employees 
JOIN Region ON Region.RegionDescription('Southern')=Region;
