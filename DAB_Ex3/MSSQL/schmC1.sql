...
--
CREATE TABLE Ansat (
    AnsatID        BIGINT IDENTITY(1,1) NOT NULL,
    VirksomhedID   BIGINT NULL,
...
--
CREATE TABLE Direktoer (
    AnsatID        BIGINT NOT NULL,
    DirektoerID    BIGINT NOT NULL,
...
CREATE TABLE Diplomingenioer (
    AnsatID        BIGINT NOT NULL,
    DiplomingenioerID BIGINT NOT NULL,
...
CREATE TABLE Civilingenioer (
    AnsatID        BIGINT NOT NULL,
    CivilingenioerID BIGINT NOT NULL,
...
--
CREATE TABLE Ansaettelsesforhold (
    AnsaettelsesforholdID BIGINT NOT NULL,
    VirksomhedID   BIGINT NULL,
    AnsatID        BIGINT NULL,
...
CREATE TABLE Fastansaettelse (
    AnsaettelsesforholdID BIGINT NOT NULL,
    FastansaettelseID BIGINT NOT NULL,
...
--
CREATE TABLE Firmabil (
    FirmaBilID     BIGINT NOT NULL,
    AnsatID        BIGINT NULL,
    DirektoerID    BIGINT NULL,
...
CREATE TABLE Projektleder (
    AnsatID        BIGINT NOT NULL,
    AnsatID1       BIGINT NOT NULL,
    DiplomingenioerID BIGINT NOT NULL,
    CivilingenioerID BIGINT NOT NULL,
    ProjektlederID BIGINT NOT NULL,
...
--
CREATE TABLE Fagforening (
    FagforeningID  BIGINT NOT NULL,
    AnsaettelsesforholdID BIGINT NULL,
    TimeloenID     BIGINT NULL,
